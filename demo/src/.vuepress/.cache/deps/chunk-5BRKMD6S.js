...
var loader$h = async () => {
  const { diagram: diagram2 } = await import("./c4Diagram-44c43e89-6IOAFKDR.js");
...
var loader$g = async () => {
  const { diagram: diagram2 } = await import("./flowDiagram-46a15f6f-EOV4JYLH.js");
...
var loader$f = async () => {
  const { diagram: diagram2 } = await import("./flowDiagram-v2-8e52592d-VYHR5F5X.js");
...
var loader$e = async () => {
  const { diagram: diagram2 } = await import("./erDiagram-20cc9db4-C76FLWIR.js");
...
var loader$d = async () => {
  const { diagram: diagram2 } = await import("./gitGraphDiagram-0a645df6-43IPZ5BU.js");
...
var loader$c = async () => {
  const { diagram: diagram2 } = await import("./ganttDiagram-04e74c0a-IXUOHMIR.js");
...
var loader$a = async () => {
  const { diagram: diagram2 } = await import("./pieDiagram-db1a8a21-RF3O65DC.js");
...
var loader$9 = async () => {
  const { diagram: diagram2 } = await import("./requirementDiagram-b9649942-TGBWB7L5.js");
...
var loader$8 = async () => {
  const { diagram: diagram2 } = await import("./sequenceDiagram-446df3e4-6ZHRSMYS.js");
...
var loader$7 = async () => {
  const { diagram: diagram2 } = await import("./classDiagram-634fc78b-M5LKNYWX.js");
...
var loader$6 = async () => {
  const { diagram: diagram2 } = await import("./classDiagram-v2-72bddc41-DRLHKL4R.js");
...
var loader$5 = async () => {
  const { diagram: diagram2 } = await import("./stateDiagram-d53d2428-732YFVZJ.js");
...
var loader$4 = async () => {
  const { diagram: diagram2 } = await import("./stateDiagram-v2-9765461d-GEBTUXQR.js");
...
var loader$3 = async () => {
  const { diagram: diagram2 } = await import("./journeyDiagram-d38aa57d-XXB2F53N.js");
...
var loader$2 = async () => {
  const { diagram: diagram2 } = await import("./flowchart-elk-definition-a44a74cb-BMUA57AA.js");
...
var loader = async () => {
  const { diagram: diagram2 } = await import("./mindmap-definition-65b51176-AST776XN.js");
...
//# sourceMappingURL=chunk-5BRKMD6S.js.map
